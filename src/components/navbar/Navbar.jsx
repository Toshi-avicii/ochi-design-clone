        ...
        >
            ...
            <div className="flex-1 flex justify-end items-center lg:hidden">
                <button className="relative">
                    <div className="w-[20px] h-[1px] rounded bg-black absolute top-1 left-1/2 -translate-x-1/2 -translate-y-1/2"></div>
                    <div className="w-[20px] h-[1px] rounded bg-black absolute top-[10px] left-1/2 -translate-x-1/2 -translate-y-[75%]"></div>
                </button>
            </div>
